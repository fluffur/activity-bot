...
type Repository interface {
	CreateMarriageRequest(ctx context.Context, chatID, fromUserID, toUserID int64) (Request, error)
	...
	GetActiveMarriageRequest(ctx context.Context, chatID, fromUserID, toUserID int64) (*Request, error)
