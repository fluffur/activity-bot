...
+адм @user — добавить администратора
-адм @user — удалить администратора (только создатель)
!update или !обновить чат — синхронизировать участников и роли

📞 <b>Прочее</b>
!калл <i>текст</i> — вызвать участников (админы)
