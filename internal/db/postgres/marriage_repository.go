...
func (r *MarriageRepository) CreateMarriageRequest(ctx context.Context, chatID, fromUserID, toUserID int64) (marriage.Request, error) {
...
func (r *MarriageRepository) GetMarriageBetweenUsers(ctx context.Context, chatID, user1ID, user2ID int64) (*marriage.Marriage, error) {
	...
	return new(mapMarriageBetweenUsersRow(m)), nil
}

func (r *MarriageRepository) GetActiveMarriageRequest(ctx context.Context, chatID, fromUserID, toUserID int64) (*marriage.Request, error) {
	...
	return new(mapMarriageRequest(req)), nil
}

func (r *MarriageRepository) UpdateMarriageRequestStatus(
	ctx context.Context,
	requestID,
	chatID int64,
	status marriage.RequestStatus,
) error {
...
func (r *MarriageRepository) ListActiveMarriages(ctx context.Context, chatID int64) ([]marriage.Marriage, error) {
	...
	return mapList(rows, mapListActiveMarriagesRow), nil
}
...
func mapActiveMarriageRow(row db.GetActiveMarriageRow) marriage.Marriage {
	return marriage.Marriage{
		...
		User1:     mapChatMemberFull(row.ChatMember, db.Chat{}, row.User),
		User2:     mapChatMemberFull(row.ChatMember_2, db.Chat{}, row.User_2),
	}
}
...
func mapMarriageRequest(r db.MarriageRequest) marriage.Request {
	return marriage.Request{
		ID:         r.ID,
		ChatID:     r.ChatID,
